...
public class QuantitysActionIDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(QuantitysActionIDController.class);
