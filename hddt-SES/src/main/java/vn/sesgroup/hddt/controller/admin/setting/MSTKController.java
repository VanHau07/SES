...
@Controller
@RequestMapping("/ql-mstk")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class MSTKController extends AbstractController{
	private static final Logger log = LogManager.getLogger(MSTKController.class);
	...
	public String init(Locale locale, Principal principal, HttpServletRequest req) throws Exception{
		req.setAttribute("_TitleView_", Constants.PREFIX_TITLE + " - Danh sách mẫu tờ khai");
		return "setting-admin/mstkhai";
	}
	...
	public BaseDTO execSearch(Locale locale, HttpServletRequest req, HttpSession session) throws Exception{
		...
		MsgRsp rsp = restAPI.callAPINormal("/ql-mstk/list", cup.getLoginRes().getToken(), HttpMethod.POST, root);
