...
public class TBHDSSotActionIDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(TBHDSSotActionIDController.class);
