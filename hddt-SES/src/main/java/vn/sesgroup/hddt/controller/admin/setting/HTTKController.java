...
@Controller
@RequestMapping("/ql-httk")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class HTTKController extends AbstractController{
	private static final Logger log = LogManager.getLogger(HTTKController.class);
	...
	public BaseDTO execSearch(Locale locale, HttpServletRequest req, HttpSession session) throws Exception{
		...
		MsgRsp rsp = restAPI.callAPINormal("/ql-httk/list", cup.getLoginRes().getToken(), HttpMethod.POST, root);
