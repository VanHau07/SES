...
@RequestMapping({
	"/tbhdssot_mtt-del",
	"/tbhdssot_mtt-send-cqt"
})
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class TBHDSSotMTTActionIDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(TBHDSSotMTTActionIDController.class);
