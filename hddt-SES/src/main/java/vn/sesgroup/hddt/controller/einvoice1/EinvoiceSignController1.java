...
public class EinvoiceSignController1 extends AbstractController{
	private static final Logger log = LogManager.getLogger(EinvoiceSignController1.class);
	...
	public BaseDTO execCheckDataToSave(Locale locale, HttpServletRequest req, HttpSession session
		...
		FileInfo fileInfo = restAPI.callAPIGetFileInfo("/einvoice1/get-files-for-sign", cup.getLoginRes().getToken(), HttpMethod.POST, root);
