...
public class QlyPhoiHDActionIDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(QlyPhoiHDActionIDController.class);
