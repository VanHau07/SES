...
@Controller
@RequestMapping({
	"/einvoice-import-auto"

})

@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class EInvoiceImportAutoController extends AbstractController{
	...
	public String init(Locale locale, HttpServletRequest req, HttpSession session
		...
		return "einvoice/einvoice-import-auto";
	}
	...
	public BaseDTO execImportData(HttpServletRequest req, HttpSession session
		...
		JSONRoot root = new JSONRoot(msg);
		MsgRsp rsp = restAPI.callAPINormal("/einvoice/import-data-auto", cup.getLoginRes().getToken(), HttpMethod.POST, root);
