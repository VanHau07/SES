...
@RequestMapping({
	"/export-del",
	"/export-send-cqt",
	"/export-send-emailauto"
})
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class ExportActionController extends AbstractController{
	private static final Logger log = LogManager.getLogger(ExportActionController.class);
	...
	public BaseDTO checkDataToSend(HttpServletRequest req, HttpSession session, String transaction
		...
		if(rspStatus.getErrorCode() == 0) {
			...
			String _tmp = "";
			title = ii.getTaxCode() + " " + ii.getName() + " Thông báo phát hành phiếu xuất kho kim vận chuyển nội bộ";
