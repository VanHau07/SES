...
public class ExportSignController extends AbstractController{
	private static final Logger log = LogManager.getLogger(ExportSignController.class);
	...
	public BaseDTO execCheckDataToSave(Locale locale, HttpServletRequest req, HttpSession session
		...
		hData.put("exportIds", ids);
		msg.setObjData(hData);
		JSONRoot root = new JSONRoot(msg);
		
		FileInfo fileInfo = restAPI.callAPIGetFileInfo("/export/get-files-for-sign", cup.getLoginRes().getToken(), HttpMethod.POST, root);
