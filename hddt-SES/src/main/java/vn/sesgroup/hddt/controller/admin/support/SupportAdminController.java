...
@Controller
@RequestMapping("/support_admin")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class SupportAdminController extends AbstractController{
	private static final Logger log = LogManager.getLogger(SupportAdminController.class);
	...
	public BaseDTO execSearch(Locale locale, HttpServletRequest req, HttpSession session) throws Exception{
		...
		MsgRsp rsp = restAPI.callAPINormal("/support_admin/list", cup.getLoginRes().getToken(), HttpMethod.POST, root);
