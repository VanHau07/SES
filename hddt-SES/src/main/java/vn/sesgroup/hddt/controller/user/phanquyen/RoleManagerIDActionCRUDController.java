...
public class RoleManagerIDActionCRUDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(RoleManagerIDActionCRUDController.class);
