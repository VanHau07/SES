...
@Controller
@RequestMapping({
	"/mauso-expires-active",
	"/mauso-expires-deactive"
})
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class MauSoExpiresActionIDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(MauSoExpiresActionIDController.class);
	...
	public BaseDTO execData(HttpServletRequest req, HttpSession session
		...
		MsgRsp rsp = restAPI.callAPINormal("/mauso-expires/crud", cup.getLoginRes().getToken(), HttpMethod.POST, root);
