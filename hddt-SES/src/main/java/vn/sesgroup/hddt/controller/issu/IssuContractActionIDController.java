...
public class IssuContractActionIDController extends AbstractController{
	private static final Logger log = LogManager.getLogger(IssuContractActionIDController.class);
