...
import vn.sesgroup.hddt.user.dao.QLTinWebDao;
...
@Repository
@Transactional
public class QLTinWebImpl extends AbstractDAO implements QLTinWebDao{
	private static final Logger log = LogManager.getLogger(QLTinWebImpl.class);
	...
	public MsgRsp crud(JSONRoot jsonRoot) throws Exception {
		...
		String link = commons.getTextJsonNode(jsonData.at("/Link"));
		String ht = commons.getTextJsonNode(jsonData.at("/HT"));
...
//////////////////////////////////////////////////////////////////////////////
		...
		case Constants.MSG_ACTION_CODE.CREATED:
			...
			MongoCollection<Document> collection = mongoClient.getDatabase(cfg.dbName).getCollection("DMInforWeb");
...
///////////////////////////////////////////////////////////////////////////////////////
		case Constants.MSG_ACTION_CODE.DELETE:
			...
			collection = mongoClient.getDatabase(cfg.dbName).getCollection("DMInforWeb");
			  try {
...
//////////////////////////////////////////////////////////////////////////////////////
		case Constants.MSG_ACTION_CODE.MODIFY:
			...
			pipeline.add(
				new Document("$lookup", 
					new Document("from", "DMInforWeb")
					.append("pipeline", 
						Arrays.asList(
							new Document("$match", docFind)
						)
					)
					.append("as", "DMInforWeb")
				)
			);
			pipeline.add(new Document("$unwind", new Document("path", "$DMInforWeb").append("preserveNullAndEmptyArrays", true)));
