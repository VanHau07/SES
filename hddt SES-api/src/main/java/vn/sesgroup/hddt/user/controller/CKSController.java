...
@RestController
@RequestMapping(value = "/cks")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class CKSController {
	Commons commons = new Commons();
	@Autowired private CKSDAO dao;
	...
	@RequestMapping(value = "/check/{_id}", method = RequestMethod.POST,
			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
			produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<?> check(@RequestBody JSONRoot jsonRoot
			, @PathVariable(name = "_id", required = false) String _id) throws Exception{
		MsgRsp rsp = dao.check(jsonRoot, _id);
