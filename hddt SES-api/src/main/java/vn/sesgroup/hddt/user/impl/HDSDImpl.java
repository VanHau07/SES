...
import vn.sesgroup.hddt.user.dao.HDSDDao;
...
@Repository
@Transactional
public class HDSDImpl extends AbstractDAO implements HDSDDao{
	private static final Logger log = LogManager.getLogger(HDSDImpl.class);
