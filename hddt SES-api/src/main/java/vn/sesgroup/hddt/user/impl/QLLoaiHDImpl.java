...
import vn.sesgroup.hddt.user.dao.QLLoaiHDDao;
...
@Repository
@Transactional
public class QLLoaiHDImpl extends AbstractDAO implements QLLoaiHDDao {
	private static final Logger log = LogManager.getLogger(QLLoaiHDImpl.class);
...
//////////////////////////////////////////////////////////////////////////////
		...
		case Constants.MSG_ACTION_CODE.CREATED:
			...
			MongoCollection<Document> collection = mongoClient.getDatabase(cfg.dbName).getCollection("LoaiHD");
			      try {
			...
			collection = mongoClient.getDatabase(cfg.dbName).getCollection("LoaiHD");
...
////////////////////////////////////////////////////////////////////////////////////////
		case Constants.MSG_ACTION_CODE.MODIFY:
			...
			pipeline.add(
				...
				pipeline.add(new Document("$unwind", new Document("path", "$LoaiHD").append("preserveNullAndEmptyArrays", true)));
