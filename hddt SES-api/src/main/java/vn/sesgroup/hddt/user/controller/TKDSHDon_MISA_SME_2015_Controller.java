...
@RestController
@RequestMapping(value = "/misaSME2015")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class TKDSHDon_MISA_SME_2015_Controller {
	@Autowired private TKDSHDon_MISA_SME_2015_DAO dao;
	...
	@RequestMapping(value = "/export-excel-vat", method = RequestMethod.POST,
			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
			produces = {MediaType.APPLICATION_OCTET_STREAM_VALUE})
	public ResponseEntity<?> exportExcelDSHDCTiet(@RequestBody JSONRoot jsonRoot) throws Exception{
		vn.sesgroup.hddt.dto.FileInfo fileInfo = dao.exportExcelDSHDVAT(jsonRoot);
