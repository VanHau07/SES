...
@RestController
@RequestMapping(value = "/issu-contract")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class IssuContractController {
	Commons commons = new Commons();
	@Autowired private IssuContractDao dao;
	...
	@RequestMapping(value = "/checkdb", method = RequestMethod.POST,
			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
			produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<?> checkdb(@RequestBody JSONRoot jsonRoot) throws Exception{
		MsgRsp rsp = dao.checkdb(jsonRoot);
		HttpHeaders headers = new HttpHeaders();
		headers.add(HttpHeaders.CONTENT_TYPE, "application/json; charset=UTF-8");
		return ResponseEntity.ok()
				.headers(headers)
	...
	@RequestMapping(value = "/updatedb", method = RequestMethod.POST,
			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
			produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<?> updatedb(@RequestBody JSONRoot jsonRoot) throws Exception{
		MsgRsp rsp = dao.updatedb(jsonRoot);
		HttpHeaders headers = new HttpHeaders();
		headers.add(HttpHeaders.CONTENT_TYPE, "application/json; charset=UTF-8");
		return ResponseEntity.ok()
				.headers(headers)
	...
	@RequestMapping(value = "/listcks", method = RequestMethod.POST,
			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
			produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<?> listcks(@RequestBody JSONRoot jsonRoot) throws Exception{
		MsgRsp rsp = dao.listcks(jsonRoot);
		HttpHeaders headers = new HttpHeaders();
		headers.add(HttpHeaders.CONTENT_TYPE, "application/json; charset=UTF-8");
		return ResponseEntity.ok()
				.headers(headers)
	...
	@RequestMapping(value = "/listnguoimua", method = RequestMethod.POST,
			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
			produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<?> listnguoimua(@RequestBody JSONRoot jsonRoot) throws Exception{
		MsgRsp rsp = dao.listnguoimua(jsonRoot);
		HttpHeaders headers = new HttpHeaders();
		headers.add(HttpHeaders.CONTENT_TYPE, "application/json; charset=UTF-8");
		return ResponseEntity.ok()
				.headers(headers)
