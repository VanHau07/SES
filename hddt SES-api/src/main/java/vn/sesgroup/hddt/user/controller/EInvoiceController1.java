...
@RestController
@RequestMapping(value = "/einvoice1")
@Scope(value = WebApplicationContext.SCOPE_REQUEST)
public class EInvoiceController1 {
	Commons commons = new Commons();
	@Autowired private EInvoiceDAO1 dao;
...
//	@RequestMapping(value = "/get-files-for-sign", method = RequestMethod.POST,
//			consumes = {MediaType.APPLICATION_JSON_VALUE},		//MediaType.TEXT_PLAIN_VALUE, 
//			produces = {MediaType.APPLICATION_OCTET_STREAM_VALUE})
//	public ResponseEntity<?> getFilesForSign(@RequestBody JSONRoot jsonRoot) throws Exception{
//		FileInfo fileInfo = dao.getFilesForSign(jsonRoot);
//		
//		HttpHeaders headers = new HttpHeaders();
//		headers.add("content-disposition", "attachment; filename=" + "template.data");
//		headers.add("Content-Type", MediaType.APPLICATION_OCTET_STREAM_VALUE);
