...
public class Constants {
	...
	public static final class TEMPLATE_FILE_NAME {
		...
		public static final String IMG_INV_XoaBo = "img-inv-xoabo-no-bg.png";
		...
		public static final String EXCEL_SENDMAILHD_CTIET = "chi-tiet-danh-sach-gui-mai-hoa-don.xlsx";
		
		public static final String EXCEL_TKDSHD_MISA_SME_2015 = "Ban_hang_MISA_SME_NET_2015.xlsx";
		
		public static final String EXCEL_TKDSHDMTT_CTIET = "thong-ke-chi-tiet-danh-sach-hoa-don-tu-may-tinh-tien.xlsx";
		public static final String EXCEL_TKDSHDMTT_GENERAL = "Report-BKHD-MTT-General.xlsx";
		
		public static final String EXCEL_BAOCAOTHONGKE = "bao-cao-thong-ke.xlsx";
		
		public static final String EXCEL_TK_LECH_SHD = "thong-ke-chi-tiet-danh-sach-hoa-don-lech.xlsx";
	}
	...
	public static final class SendMailFromFunc{
	...
	public static final LinkedHashMap<String, String> MAP_EInvoiceStatus_TBN = new LinkedHashMap<String, String>(){
		private static final long serialVersionUID = 4659557633581867222L;
